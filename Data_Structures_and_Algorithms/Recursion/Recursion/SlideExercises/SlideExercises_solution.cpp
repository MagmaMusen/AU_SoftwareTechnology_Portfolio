...
//====================================================================
// Algorithm				: sum2()
// (1) State the problem	: Find the sum of 1..n, n>=1
// (2) Find and handle BC	: n==1: sum2 =1
// (3) Find and handle RC	: n>1 : sum2 = n + sum2(ar+1, n-1)
...
double power(int x, int exp)
{
	...
	else if (exp < 0)	return 1 / power(x, -exp);   // x-exp = 1/xexp
	else				return x*power(x, exp - 1); // xexp = x * xexp-1
}
